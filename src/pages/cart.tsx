...
import { checkout, getCart } from "../redux/slices/cart-slice";
        ...
        <>
            ...
            <div className="p-5 flex flex-col max-sm:p-2.5">
                ...
                <div className="flex items-center justify-between p-5 max-sm:space-x-2">
                    ...
                    <button className="p-2.5 font-semibold cursor-pointer bg-black text-white" disabled={cart.cart.cartQuantity <= 0 && cart.isCheckingout === true}> {
                        cart.isCheckingout
                            ? <Triangle
                                visible={true}
                                height="20"
                ...
                <div className="flex justify-between space-x-1 max-sm:flex-col max-sm:space-y-1">
                    <div className="flex-[3] p-5  border rounded-md bg-slate-50 space-y-1 h-[60vh] overflow-y-scroll">
                        {
                    ...
                    <div className="flex-1 border-[0.5px] border-solid rounded-md  p-5 bg-slate-50 ">
                        ...
                        <button className="w-full bg-black text-white p-2.5 font-semibold transition" disabled={cart.cart.cartQuantity <= 0 && cart.isCheckingout === true} onClick={() => dispatch(checkout())}> {
                            cart.isCheckingout
                                ? <Triangle
                                    visible={true}
                                    height="20"
