    ...
    return (
        <div className="h-screen w-screen flex items-center">
            ...
            <div className="flex-1 p-12 flex flex-col justify-start items-start"  >
                ...
                <button className="rounded-full text-black text-xl bg-slate-300 px-4 py-3 shadow-2xl  flex justify-center items-center gap-3 hover:scale-105 group transition">SHOP NOW<FaArrowRight className="group-hover:translate-x-1 transition" /></button>
            </div>
